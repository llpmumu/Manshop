...
import com.manshop.android.util.event.ImageEvent;
import com.manshop.android.util.keyboard.XhsEmoticonsKeyBoard;
...
import com.manshop.android.view.ChatView;
import com.manshop.android.view.SimpleAppsGridView;
import com.manshop.android.view.TipItem;
import com.manshop.android.view.TipView;
import com.manshop.android.view.listview.DropDownListView;
...
//            Log.d("Conv","111 "+targetId+" "+appKey);
        ...
        //发送名片返回聊天界面刷新信息
        if (SharePreferenceUtil.getIsOpen()) {
            initData();
            SharePreferenceUtil.setIsOpen(false);
        }
        super.onResume();
